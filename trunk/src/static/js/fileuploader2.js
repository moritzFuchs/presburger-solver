...
qq.FileUploader = function(o){
    this._options = {
        ...
        template: '<div class="qq-uploader">' + 
                '<div class="qq-upload-drop-area drop"></div>' +
                '<div class="qq-upload-button area"></div>' +
             '</div>'+
             '<div id="upload_list_wrap"><ul class="qq-upload-list"></ul></div>',
...
qq.FileUploader.prototype = {
    ...
    _setupDragDrop: function(){
        ...
        dc = self._options.dropContainer || document;
        ...
        qq.attach(dropArea.parentNode, 'dragover', function(e){
            if (isValidDrag(e)){
        ...
        qq.attach(dc, 'dragleave', function(e){  
            if (isValidDrag(e)){
